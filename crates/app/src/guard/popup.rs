...
main { flex: 1; overflow: auto; padding: 12px 13px; }
.text {
...
<body>
<header>
  <h1>id4pii — restored</h1>
  <span class="badge" id="badge">PII unmasked</span>
</header>
...
<script>
  ...
  document.getElementById("copy").addEventListener("click", () => {
    window.ipc.postMessage("copy");
    document.getElementById("badge").textContent = "copied";
  });
