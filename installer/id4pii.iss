...
#define MyAppDaemonExeName "id4pii-daemon.exe"
...
UninstallDisplayIcon={app}\{#MyAppDaemonExeName}
...
[Tasks]
Name: "autostart"; Description: "Run id4pii daemon on Windows login"; GroupDescription: "Startup:"
...
Source: "..\target\release\{#MyAppDaemonExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\README.md"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LICENSE"; DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist

[Icons]
Name: "{group}\id4pii"; Filename: "{app}\{#MyAppDaemonExeName}"; IconFilename: "{app}\{#MyAppDaemonExeName}"; Comment: "Start id4pii daemon in the system tray"
Name: "{group}\Open id4pii log folder"; Filename: "{localappdata}\id4pii\logs"; Comment: "View id4pii daemon logs"
Name: "{group}\{cm:UninstallProgram,id4pii}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\id4pii"; Filename: "{app}\{#MyAppDaemonExeName}"; IconFilename: "{app}\{#MyAppDaemonExeName}"; Tasks: desktopicon
...
Root: HKCU; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; ValueType: string; ValueName: "id4pii"; ValueData: """{app}\{#MyAppDaemonExeName}"""; Flags: uninsdeletevalue; Tasks: autostart
...
Filename: "{app}\{#MyAppDaemonExeName}"; Description: "Launch id4pii daemon now"; Flags: nowait postinstall skipifsilent
